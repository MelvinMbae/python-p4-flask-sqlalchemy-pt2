...
# point to our existing db
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///app.db'

# Set to false to avoid too much unhelpful data in memory when our app is running
...
@app.route('/')
def index():
    # Responses are what we return to the client after a request
